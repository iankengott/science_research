...
NPsis = 210 -- Number of states to consider in the spectra calculation.
NPsisAuto = true -- Determine the number of state automatically.
NConfigurations = 1 -- Number of configurations.

Emin = 697.0 -- Minimum value of the energy range (eV).
Emax = 737.0 -- Maximum value of the energy range (eV).
NPoints = 2000 -- Number of points of the spectra.
ZeroShift = 4.09995 -- Shift that brings the edge or line energy to approximately zero (eV).
ExperimentalShift = 706.8 -- Experimental edge or line energy (eV).
Gaussian = 0.0 -- 0.1 -- Gaussian FWHM (eV).
Lorentzian = {{697.0, 0.36}, {737.0, 0.36}} -- Lorentzian FWHM (eV).
...
Prefix = "Fe2+_Oh_XAS_2p" -- File name prefix.
...
if AtomicTerm then
    ...
    U_3d_3d_i = 0.0
    F2_3d_3d_i = 10.9662 * 0.8
    F4_3d_3d_i = 6.8152 * 0.8
    F0_3d_3d_i = U_3d_3d_i + 2 / 63 * F2_3d_3d_i + 2 / 63 * F4_3d_3d_i

    U_3d_3d_f = 0.0
    F2_3d_3d_f = 11.7788 * 0.8
    F4_3d_3d_f = 7.3273 * 0.8
    F0_3d_3d_f = U_3d_3d_f + 2 / 63 * F2_3d_3d_f + 2 / 63 * F4_3d_3d_f
    U_2p_3d_f = 0.0
    F2_2p_3d_f = 6.7932 * 0.8
    G1_2p_3d_f = 5.0035 * 0.8
    G3_2p_3d_f = 2.8442 * 0.8
    ...
    zeta_3d_f = 0.0665 * 1.0
    zeta_2p_f = 8.1999 * 1.0
